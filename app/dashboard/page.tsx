          ...
          <section className="grid gap-6 xl:grid-cols-[0.72fr_1.28fr]">
            <article className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-[0_20px_50px_rgba(15,23,42,0.06)]">
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Crea nuevas cuentas internas y define si tendran perfil de
                  administrador o solo visualizacion.
                </p>
              </div>
            ...
            <article className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-[0_20px_50px_rgba(15,23,42,0.06)]">
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Desde aqui puedes activar o desactivar cuentas, cambiar roles y
