...
export function AppShell({
  ...
  return (
    <main className="min-h-screen bg-[#f6f8f7] text-slate-900">
      <div className="mx-auto flex min-h-screen w-full max-w-[1760px] flex-col gap-4 px-4 py-4 md:px-5 xl:px-6">
        <header className="rounded-[1.5rem] bg-slate-950 px-5 py-4 text-white shadow-[0_18px_55px_rgba(15,23,42,0.2)] md:px-6">
